...
- **AR.js artoolkit plugin 0.1.3** (@ar-js-org/arjs-plugin-artoolkit) —
  Copyright (c) AR.js contributors. Distributed under the
  [MIT License](LICENSES/AR.js-MIT.txt). Its marker-tracking engine
  **ARToolKit5 / jsartoolkit5** (@ar-js-org/artoolkit5-js), Copyright
  (c) ARToolworks / artoolkitx contributors, is distributed under
  [LGPL-3.0 with additional permissions](LICENSES/jsartoolkit5-LGPL.txt)
