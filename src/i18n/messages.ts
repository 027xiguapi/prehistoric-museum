...
const zhCN = {
  ...
  ar: {
    ...
    scanning: '正在寻找标记卡片…',
    pointAtMarker: '把打印好的标记卡片平放在桌上，用摄像头对准它。',
    trackingHint: '找到了！轻点画面或按 Esc 退出。',
    lost: '暂时看不到标记，靠近一点、光线亮一点试试。',
...
const en = {
  ...
  ar: {
    ...
    scanning: 'Looking for the marker card…',
    pointAtMarker:
      'Place the printed marker card flat on the table and point the camera at it.',
    trackingHint: 'Found it! Tap the scene or press Esc to exit.',
    lost: 'Can’t see the marker right now. Move closer or try brighter light.',
