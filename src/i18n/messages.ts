...
const zhCN = {
  ...
  ar: {
    ...
    close: '退出 AR',
    xrSearching: '轻点屏幕，把动物放在你面前！',
    xrPlaced: '出现啦！轻点屏幕可再放一次，点右上角退出。',
    cameraMode: '它来到你身边啦！转动手机四处看看，轻点画面让它回到面前。',
    switchAnimal: '换一只动物',
  },
} as const
...
const en = {
  ...
  ar: {
    ...
    close: 'Exit AR',
    xrSearching: 'Tap the screen to place the animal right in front of you!',
    xrPlaced: 'It’s here! Tap the screen to place again, or ✕ to exit.',
    cameraMode:
      'It’s right beside you! Look around by turning the phone; tap the view to bring it back in front.',
