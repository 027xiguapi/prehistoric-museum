...
import { animal as apatosaurus } from '@/src/review/animals/apatosaurus/package'
import { animal as gigantoraptor } from '@/src/review/animals/gigantoraptor/package'
import { animal as ichthyosaur } from '@/src/review/animals/ichthyosaur/package'
import { animal as maiasaura } from '@/src/review/animals/maiasaura/package'
import { animal as mammoth } from '@/src/review/animals/mammoth/package'
import { animal as megalodon } from '@/src/review/animals/megalodon/package'
import { animal as pachycephalosaurus } from '@/src/review/animals/pachycephalosaurus/package'
import { animal as plesiosaurus } from '@/src/review/animals/plesiosaurus/package'
import { animal as pteranodon } from '@/src/review/animals/pteranodon/package'
import { animal as triceratops } from '@/src/review/animals/triceratops/package'
import { animal as tyrannosaurusRex } from '@/src/review/animals/tyrannosaurus-rex/package'
import { animal as dilophosaurusDraft } from '@/src/review/animals/dilophosaurus/package'
import { animal as mosasaurusDraft } from '@/src/review/animals/mosasaurus/package'
import { animal as sauropeltaDraft } from '@/src/review/animals/sauropelta/package'
import { animal as rhamphorhynchusDraft } from '@/src/review/animals/rhamphorhynchus/package'
import { animal as tupandactylusDraft } from '@/src/review/animals/tupandactylus/package'
import { animal as meganeuraDraft } from '@/src/review/animals/meganeura/package'
import type {
