...
export const zhCN = {
  ...
  parentClassificationNote:
    '喙嘴翼龙属于翼龙类，是会主动飞行的爬行动物，不是恐龙，也不是鸟。德国南部的晚侏罗世标本保存了翼膜和尾端软组织帆；鱼类胃内容物证明小鱼是它的食物之一，一件带喙嘴翼龙牙齿的头足类化石还记录了一次可能失败的捕食。不同年龄的尾帆形状会变化，体色、完整翼膜轮廓和具体飞行动作仍属于科学约束下的艺术复原。',
  sources: [
    {
      title:
