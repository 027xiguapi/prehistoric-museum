...
export function ArViewer({
  ...
  // Boot the AR session once. The plugin (and Three.js AR renderer) are pulled
  // in via dynamic import so they stay in a separate chunk until AR opens.
  useEffect(() => {
  ...
  return (
    <div
      ...
      role="dialog"
    >
      <div aria-hidden="true" className="ar-stage" ref={containerRef} />
      <button
