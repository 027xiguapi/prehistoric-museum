...
/**
 * Content-only 404 for use inside the [locale] layout, which already renders
 * the <html>/<body> shell. Rendering another shell here would nest
 * <html>/<body> and break hydration.
 */
