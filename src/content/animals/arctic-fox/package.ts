...
import { en } from '@/src/content/animals/arctic-fox/content.en'
import { zhCN } from '@/src/content/animals/arctic-fox/content.zh-CN'
import { provenance } from '@/src/content/animals/arctic-fox/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 0.637 米、长约 1.324 米，初始朝向 45°）。',
