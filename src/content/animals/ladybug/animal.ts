import posterPortraitUrl from '@/src/content/animals/ladybug/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/ladybug/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/ladybug/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a ladybug
...
import { animalDefinition } from '@/src/content/animals/ladybug/package'
...
// preview it at /{locale}/animal/ladybug/. Production builds filter
