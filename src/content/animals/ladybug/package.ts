...
import { en } from '@/src/content/animals/ladybug/content.en'
import { zhCN } from '@/src/content/animals/ladybug/content.zh-CN'
import { provenance } from '@/src/content/animals/ladybug/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 0.008 米、长约 0.017 米，初始朝向 180°）。',
