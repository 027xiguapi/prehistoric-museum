import posterPortraitUrl from '@/src/content/animals/schnauzer/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/schnauzer/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/schnauzer/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a schnauzer
...
import { animalDefinition } from '@/src/content/animals/schnauzer/package'
...
// server can preview it at /{locale}/animal/schnauzer/. Production builds
