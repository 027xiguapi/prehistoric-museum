...
import { en } from '@/src/content/animals/zebra/content.en'
import { zhCN } from '@/src/content/animals/zebra/content.zh-CN'
import { provenance } from '@/src/content/animals/zebra/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  animation: {
    clip: "All Animations_skeleton #0.001",
    loop: 'repeat',
    speed: 1,
  },
  narration: {
  ...
  provenance,
  draftNotes: [
    '试点草稿：模型已按米制规范化并落地（高约 2.333 米、长约 2.5 米）。',
    '待机动画 clip 名为 “All Animations_skeleton #0.001”，在真实浏览器中验证动作幅度后再决定是否重命名或调速度。',
