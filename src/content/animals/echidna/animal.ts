import posterPortraitUrl from '@/src/content/animals/echidna/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/echidna/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/echidna/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a echidna
...
import { animalDefinition } from '@/src/content/animals/echidna/package'
...
// preview it at /{locale}/animal/echidna/. Production builds filter
