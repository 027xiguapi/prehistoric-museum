import posterPortraitUrl from '@/src/content/animals/ragdoll/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/ragdoll/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/ragdoll/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a ragdoll
...
import { animalDefinition } from '@/src/content/animals/ragdoll/package'
...
// preview it at /{locale}/animal/ragdoll/. Production builds filter
