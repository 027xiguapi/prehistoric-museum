import posterPortraitUrl from '@/src/content/animals/python/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/python/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/python/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a python
...
import { animalDefinition } from '@/src/content/animals/python/package'
...
// server can preview it at /{locale}/animal/python/. Production builds
