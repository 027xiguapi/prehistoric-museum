import posterPortraitUrl from '@/src/content/animals/velociraptor/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/velociraptor/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/velociraptor/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a velociraptor
...
import { animalDefinition } from '@/src/content/animals/velociraptor/package'
...
// preview it at /{locale}/animal/velociraptor/. Production builds filter
