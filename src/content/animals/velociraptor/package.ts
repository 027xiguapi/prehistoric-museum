...
import { en } from '@/src/content/animals/velociraptor/content.en'
import { zhCN } from '@/src/content/animals/velociraptor/content.zh-CN'
import { provenance } from '@/src/content/animals/velociraptor/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 1.26 米、长约 2.631 米，初始朝向 45°）。',
