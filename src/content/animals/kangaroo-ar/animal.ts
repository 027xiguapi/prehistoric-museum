import posterPortraitUrl from '@/src/content/animals/kangaroo-ar/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/kangaroo-ar/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/kangaroo-ar/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a kangaroo-ar
...
import { animalDefinition } from '@/src/content/animals/kangaroo-ar/package'
...
// preview it at /{locale}/animal/kangaroo-ar/. Production builds filter
