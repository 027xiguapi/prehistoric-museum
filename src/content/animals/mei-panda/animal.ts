import posterPortraitUrl from '@/src/content/animals/mei-panda/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/mei-panda/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/mei-panda/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a mei-panda
...
import { animalDefinition } from '@/src/content/animals/mei-panda/package'
...
// preview it at /{locale}/animal/mei-panda/. Production builds filter
