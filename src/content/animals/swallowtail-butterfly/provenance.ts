...
export const provenance: readonly [AssetProvenance, ...AssetProvenance[]] = [
  {
    ...
    attribution: "Swallowtail Butterfly 3D model from the Google “AR Answers in Search” models bucket; licence pending confirmation.",
    redistributionAllowed: true,
    evidencePaths: [
      "model-downloads/insects/swallowtail_butterfly/model.glb",
      'converted-downloads/swallowtail-butterfly/model-normalized.glb',
