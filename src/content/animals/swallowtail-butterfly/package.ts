...
import { en } from '@/src/content/animals/swallowtail-butterfly/content.en'
import { zhCN } from '@/src/content/animals/swallowtail-butterfly/content.zh-CN'
import { provenance } from '@/src/content/animals/swallowtail-butterfly/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 0.031 米、长约 0.087 米）。',
    '待机动画 clip 名为 “namiage”，在真实浏览器中验证动作幅度后再决定是否重命名或调速度。',
