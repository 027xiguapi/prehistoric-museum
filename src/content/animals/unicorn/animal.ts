import posterPortraitUrl from '@/src/content/animals/unicorn/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/unicorn/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/unicorn/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a unicorn
...
import { animalDefinition } from '@/src/content/animals/unicorn/package'
...
// preview it at /{locale}/animal/unicorn/. Production builds filter
