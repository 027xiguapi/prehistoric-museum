import posterPortraitUrl from '@/src/content/animals/deer/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/deer/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/deer/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a deer
...
import { animalDefinition } from '@/src/content/animals/deer/package'
...
// server can preview it at /{locale}/animal/deer/. Production builds
...
export const animal: DraftAnimalPackage & LegacyLocalReviewAnimalPackage = {
  ...
  review: {
    ...
    checks: [
      '模型已按米制规范化并落地',
      '待机动画 clip “Deer_female_rig.ao|Deer_female_rig.ao|Deer_female_idle|Deer_fem” 待真实浏览器验收',
      '缩略图与海报已从模型渲染',
    ],
    accent: {
      strong: '#8c6a45',
