import posterPortraitUrl from '@/src/content/animals/border-collie/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/border-collie/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/border-collie/images/thumbnail.webp'
...
import landscapeUrl from '@/src/content/animals/border-collie/backgrounds/landscape.webp'
import portraitUrl from '@/src/content/animals/border-collie/backgrounds/portrait.webp'

import { imageUrl } from '@/src/content/create-runtime-animal'
import { animalAssetUrl } from '@/src/content/remote-assets'
import { animalDefinition } from '@/src/content/animals/border-collie/package'
...
// preview it at /{locale}/animal/border-collie/. Production builds filter
