import posterPortraitUrl from '@/src/content/animals/pig/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/pig/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/pig/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a pig
...
import { animalDefinition } from '@/src/content/animals/pig/package'
...
// preview it at /{locale}/animal/pig/. Production builds filter
