import posterPortraitUrl from '@/src/content/animals/milk-cow/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/milk-cow/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/milk-cow/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a milk-cow
...
import { animalDefinition } from '@/src/content/animals/milk-cow/package'
...
// preview it at /{locale}/animal/milk-cow/. Production builds filter
