...
import { en } from '@/src/content/animals/stegosaurus-ar/content.en'
import { zhCN } from '@/src/content/animals/stegosaurus-ar/content.zh-CN'
import { provenance } from '@/src/content/animals/stegosaurus-ar/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 5.079 米、长约 11.259 米，初始朝向 225°）。',
