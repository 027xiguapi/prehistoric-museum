...
import { en } from '@/src/content/animals/eagle/content.en'
import { zhCN } from '@/src/content/animals/eagle/content.zh-CN'
import { provenance } from '@/src/content/animals/eagle/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '现代动物草稿：模型已按米制规范化并落地（高约 1.814 米、长约 2 米）。',
    '待机动画 clip 名为 “CINEMA_4D_Principal”，在真实浏览器中验证动作幅度后再决定是否重命名或调速度。',
