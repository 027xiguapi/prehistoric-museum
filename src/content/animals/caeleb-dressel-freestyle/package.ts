...
import { en } from '@/src/content/animals/caeleb-dressel-freestyle/content.en'
import { zhCN } from '@/src/content/animals/caeleb-dressel-freestyle/content.zh-CN'
import { provenance } from '@/src/content/animals/caeleb-dressel-freestyle/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 2.3 米、长约 1.209 米）。',
    '待机动画 clip 名为 “inPlace”，在真实浏览器中验证动作幅度后再决定是否重命名或调速度。',
