...
import { en } from '@/src/content/animals/pv-sindhu-rally/content.en'
import { zhCN } from '@/src/content/animals/pv-sindhu-rally/content.zh-CN'
import { provenance } from '@/src/content/animals/pv-sindhu-rally/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 0.947 米、长约 2.1 米）。',
