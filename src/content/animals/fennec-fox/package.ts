...
import { en } from '@/src/content/animals/fennec-fox/content.en'
import { zhCN } from '@/src/content/animals/fennec-fox/content.zh-CN'
import { provenance } from '@/src/content/animals/fennec-fox/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '试点草稿：模型已按米制规范化并落地（高约 0.488 米、长约 0.65 米）。',
