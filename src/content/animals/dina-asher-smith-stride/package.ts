...
import { en } from '@/src/content/animals/dina-asher-smith-stride/content.en'
import { zhCN } from '@/src/content/animals/dina-asher-smith-stride/content.zh-CN'
import { provenance } from '@/src/content/animals/dina-asher-smith-stride/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 2.1 米、长约 1.443 米，初始朝向 270°）。',
