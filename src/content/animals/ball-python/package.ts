...
import { en } from '@/src/content/animals/ball-python/content.en'
import { zhCN } from '@/src/content/animals/ball-python/content.zh-CN'
import { provenance } from '@/src/content/animals/ball-python/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 0.223 米、长约 1.5 米，初始朝向 180°）。',
