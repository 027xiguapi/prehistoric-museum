import posterPortraitUrl from '@/src/content/animals/quokka/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/quokka/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/quokka/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a quokka
...
import { animalDefinition } from '@/src/content/animals/quokka/package'
...
// preview it at /{locale}/animal/quokka/. Production builds filter
