import posterPortraitUrl from '@/src/content/animals/brown-cicada/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/brown-cicada/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/brown-cicada/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a brown-cicada
...
import { animalDefinition } from '@/src/content/animals/brown-cicada/package'
...
// preview it at /{locale}/animal/brown-cicada/. Production builds filter
