...
import { en } from '@/src/content/animals/brown-cicada/content.en'
import { zhCN } from '@/src/content/animals/brown-cicada/content.zh-CN'
import { provenance } from '@/src/content/animals/brown-cicada/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 0.018 米、长约 0.06 米）。',
