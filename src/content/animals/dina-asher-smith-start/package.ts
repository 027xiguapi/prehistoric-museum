...
import { en } from '@/src/content/animals/dina-asher-smith-start/content.en'
import { zhCN } from '@/src/content/animals/dina-asher-smith-start/content.zh-CN'
import { provenance } from '@/src/content/animals/dina-asher-smith-start/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 2 米、长约 1.869 米，初始朝向 270°）。',
