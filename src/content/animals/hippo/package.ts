...
import { en } from '@/src/content/animals/hippo/content.en'
import { zhCN } from '@/src/content/animals/hippo/content.zh-CN'
import { provenance } from '@/src/content/animals/hippo/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 1.719 米、长约 3.8 米）。',
