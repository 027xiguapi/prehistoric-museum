...
import { en } from '@/src/content/animals/jellyfish/content.en'
import { zhCN } from '@/src/content/animals/jellyfish/content.zh-CN'
import { provenance } from '@/src/content/animals/jellyfish/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '现代动物草稿：模型已按米制规范化并落地（高约 0.211 米、长约 0.228 米）。',
