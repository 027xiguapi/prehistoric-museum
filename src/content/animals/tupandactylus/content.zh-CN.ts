...
export const zhCN = {
  ...
  "parentClassificationNote": "古神翼龙属于翼龙类，是会主动飞行的爬行动物，不是恐龙，也不是鸟。巴西克拉图组标本保存了无齿的喙和由骨质支架、软组织共同构成的巨大头冠；一件近完整成年古神翼龙标本估算翼展约 2.7 米。有研究提出它可能取食植物、也可能受巨大头冠限制而更擅长短距离飞行，但这些解释还不是直接食物或行为证据。模型的冠饰颜色、翼膜花纹和具体拍翼方式都是科学约束下的艺术复原。",
  "sources": [
    {
