import posterPortraitUrl from '@/src/content/animals/duck/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/duck/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/duck/images/thumbnail.webp'

// Draft preview only: borrow the mosasaurus backdrop until a duck
...
import { animalDefinition } from '@/src/content/animals/duck/package'
...
// server can preview it at /{locale}/animal/duck/. Production builds
