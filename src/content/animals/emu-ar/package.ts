...
import { en } from '@/src/content/animals/emu-ar/content.en'
import { zhCN } from '@/src/content/animals/emu-ar/content.zh-CN'
import { provenance } from '@/src/content/animals/emu-ar/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 1.629 米、长约 1.7 米）。',
