import posterPortraitUrl from '@/src/content/animals/maltese/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/maltese/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/maltese/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a maltese
...
import { animalDefinition } from '@/src/content/animals/maltese/package'
...
// preview it at /{locale}/animal/maltese/. Production builds filter
