import posterPortraitUrl from '@/src/content/animals/octopus/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/octopus/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/octopus/images/thumbnail.webp'

// Draft preview only: borrow the mosasaurus backdrop until a octopus
...
import { animalDefinition } from '@/src/content/animals/octopus/package'
...
// server can preview it at /{locale}/animal/octopus/. Production builds
...
export const animal: DraftAnimalPackage & LegacyLocalReviewAnimalPackage = {
  ...
  review: {
    ...
    checks: [
      '模型已按米制规范化并落地',
      '待机动画 clip “Bone001|Unreal Take|Base Layer Retarget” 待真实浏览器验收',
      '缩略图与海报已从模型渲染',
    ],
    accent: {
      strong: '#7a4f68',
