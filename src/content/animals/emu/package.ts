...
import { en } from '@/src/content/animals/emu/content.en'
import { zhCN } from '@/src/content/animals/emu/content.zh-CN'
import { provenance } from '@/src/content/animals/emu/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '试点草稿：模型已按米制规范化并落地（高约 1.629 米、长约 1.7 米）。',
