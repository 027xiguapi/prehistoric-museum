import posterPortraitUrl from '@/src/content/animals/donkey/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/donkey/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/donkey/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a donkey
...
import { animalDefinition } from '@/src/content/animals/donkey/package'
...
// preview it at /{locale}/animal/donkey/. Production builds filter
