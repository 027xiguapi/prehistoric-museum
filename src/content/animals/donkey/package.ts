...
import { en } from '@/src/content/animals/donkey/content.en'
import { zhCN } from '@/src/content/animals/donkey/content.zh-CN'
import { provenance } from '@/src/content/animals/donkey/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 1.423 米、长约 1.9 米）。',
