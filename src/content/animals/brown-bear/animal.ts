import posterPortraitUrl from '@/src/content/animals/brown-bear/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/brown-bear/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/brown-bear/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a brown-bear
...
import { animalDefinition } from '@/src/content/animals/brown-bear/package'
...
// preview it at /{locale}/animal/brown-bear/. Production builds filter
