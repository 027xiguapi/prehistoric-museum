import posterPortraitUrl from '@/src/content/animals/doberman/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/doberman/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/doberman/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a doberman
...
import { animalDefinition } from '@/src/content/animals/doberman/package'
...
// preview it at /{locale}/animal/doberman/. Production builds filter
