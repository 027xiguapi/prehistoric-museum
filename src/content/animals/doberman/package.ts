...
import { en } from '@/src/content/animals/doberman/content.en'
import { zhCN } from '@/src/content/animals/doberman/content.zh-CN'
import { provenance } from '@/src/content/animals/doberman/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 1.173 米、长约 1.25 米）。',
