import posterPortraitUrl from '@/src/content/animals/sparrow/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/sparrow/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/sparrow/images/thumbnail.webp'

// Draft preview only: borrow the pteranodon backdrop until a sparrow
...
import { animalDefinition } from '@/src/content/animals/sparrow/package'
...
// server can preview it at /{locale}/animal/sparrow/. Production builds
...
export const animal: DraftAnimalPackage & LegacyLocalReviewAnimalPackage = {
  ...
  review: {
    ...
    checks: [
      '模型已按米制规范化并落地',
      '待机动画 clip “Sparrow_hover” 待真实浏览器验收',
      '缩略图与海报已从模型渲染',
    ],
    accent: {
      strong: '#7a6248',
