import posterPortraitUrl from '@/src/content/animals/grogu/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/grogu/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/grogu/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a grogu
...
import { animalDefinition } from '@/src/content/animals/grogu/package'
...
// preview it at /{locale}/animal/grogu/. Production builds filter
