import posterPortraitUrl from '@/src/content/animals/beagle/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/beagle/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/beagle/images/thumbnail.webp'
...
import landscapeUrl from '@/src/content/animals/beagle/backgrounds/landscape.webp'
import portraitUrl from '@/src/content/animals/beagle/backgrounds/portrait.webp'

import { imageUrl } from '@/src/content/create-runtime-animal'
import { animalAssetUrl } from '@/src/content/remote-assets'
import { animalDefinition } from '@/src/content/animals/beagle/package'
...
// preview it at /{locale}/animal/beagle/. Production builds filter
