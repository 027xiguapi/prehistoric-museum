import posterPortraitUrl from '@/src/content/animals/common-octopus/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/common-octopus/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/common-octopus/images/thumbnail.webp'

// Draft preview only: borrow the mosasaurus backdrop until a common-octopus
...
import { animalDefinition } from '@/src/content/animals/common-octopus/package'
...
// preview it at /{locale}/animal/common-octopus/. Production builds filter
