import posterPortraitUrl from '@/src/content/animals/goat/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/goat/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/goat/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a goat
...
import { animalDefinition } from '@/src/content/animals/goat/package'
...
// server can preview it at /{locale}/animal/goat/. Production builds
