...
import { en } from '@/src/content/animals/goat/content.en'
import { zhCN } from '@/src/content/animals/goat/content.zh-CN'
import { provenance } from '@/src/content/animals/goat/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '试点草稿：模型已按米制规范化并落地（高约 0.971 米、长约 1.2 米）。',
