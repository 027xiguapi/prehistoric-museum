import posterPortraitUrl from '@/src/content/animals/short-haired-cat/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/short-haired-cat/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/short-haired-cat/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a short-haired-cat
...
import { animalDefinition } from '@/src/content/animals/short-haired-cat/package'
...
// preview it at /{locale}/animal/short-haired-cat/. Production builds filter
