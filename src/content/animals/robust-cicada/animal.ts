import posterPortraitUrl from '@/src/content/animals/robust-cicada/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/robust-cicada/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/robust-cicada/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a robust-cicada
...
import { animalDefinition } from '@/src/content/animals/robust-cicada/package'
...
// preview it at /{locale}/animal/robust-cicada/. Production builds filter
