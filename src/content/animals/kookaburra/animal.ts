import posterPortraitUrl from '@/src/content/animals/kookaburra/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/kookaburra/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/kookaburra/images/thumbnail.webp'

// Draft preview only: borrow the pteranodon backdrop until a kookaburra
...
import { animalDefinition } from '@/src/content/animals/kookaburra/package'
...
// server can preview it at /{locale}/animal/kookaburra/. Production builds
...
export const animal: DraftAnimalPackage & LegacyLocalReviewAnimalPackage = {
  ...
  review: {
    ...
    checks: [
      '模型已按米制规范化并落地',
      '待机动画 clip “All Animations_skeleton #0” 待真实浏览器验收',
      '缩略图与海报已从模型渲染',
    ],
    accent: {
      strong: '#5b6d8c',
