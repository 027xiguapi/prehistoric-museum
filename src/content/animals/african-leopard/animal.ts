import posterPortraitUrl from '@/src/content/animals/african-leopard/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/african-leopard/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/african-leopard/images/thumbnail.webp'
...
import landscapeUrl from '@/src/content/animals/african-leopard/backgrounds/landscape.webp'
import portraitUrl from '@/src/content/animals/african-leopard/backgrounds/portrait.webp'

import { imageUrl } from '@/src/content/create-runtime-animal'
import { animalAssetUrl } from '@/src/content/remote-assets'
import { animalDefinition } from '@/src/content/animals/african-leopard/package'
...
// preview it at /{locale}/animal/african-leopard/. Production builds filter
