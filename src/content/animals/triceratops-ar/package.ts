...
import { en } from '@/src/content/animals/triceratops-ar/content.en'
import { zhCN } from '@/src/content/animals/triceratops-ar/content.zh-CN'
import { provenance } from '@/src/content/animals/triceratops-ar/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 4.582 米、长约 9 米，初始朝向 90°）。',
