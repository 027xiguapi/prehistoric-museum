...
import { en } from '@/src/content/animals/hercules-beetle-ar/content.en'
import { zhCN } from '@/src/content/animals/hercules-beetle-ar/content.zh-CN'
import { provenance } from '@/src/content/animals/hercules-beetle-ar/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 0.069 米、长约 0.17 米）。',
    '待机动画 clip 名为 “hurkyury”，在真实浏览器中验证动作幅度后再决定是否重命名或调速度。',
