import posterPortraitUrl from '@/src/content/animals/owl/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/owl/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/owl/images/thumbnail.webp'

// Draft preview only: borrow the pteranodon backdrop until a owl
...
import { animalDefinition } from '@/src/content/animals/owl/package'
...
// server can preview it at /{locale}/animal/owl/. Production builds
...
export const animal: DraftAnimalPackage & LegacyLocalReviewAnimalPackage = {
  ...
  review: {
    ...
    checks: [
      '模型已按米制规范化并落地',
      '待机动画 clip “fly fast lol” 待真实浏览器验收',
      '缩略图与海报已从模型渲染',
    ],
    accent: {
      strong: '#82694f',
