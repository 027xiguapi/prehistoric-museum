import posterPortraitUrl from '@/src/content/animals/rottweiler/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/rottweiler/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/rottweiler/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a rottweiler
...
import { animalDefinition } from '@/src/content/animals/rottweiler/package'
...
// preview it at /{locale}/animal/rottweiler/. Production builds filter
