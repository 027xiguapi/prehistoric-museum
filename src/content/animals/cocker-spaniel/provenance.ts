...
export const provenance: readonly [AssetProvenance, ...AssetProvenance[]] = [
  {
    ...
    attribution: "Cocker Spaniel 3D model from the Google “AR Answers in Search” models bucket; licence pending confirmation.",
    redistributionAllowed: false,
    evidencePaths: [
      "model-downloads/dogs/Cockerspaniel/Cockerspaniel.glb",
      'converted-downloads/cocker-spaniel/model-normalized.glb',
