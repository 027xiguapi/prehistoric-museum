import posterPortraitUrl from '@/src/content/animals/maine-coon/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/maine-coon/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/maine-coon/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a maine-coon
...
import { animalDefinition } from '@/src/content/animals/maine-coon/package'
...
// preview it at /{locale}/animal/maine-coon/. Production builds filter
