import posterPortraitUrl from '@/src/content/animals/pony/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/pony/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/pony/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a pony
...
import { animalDefinition } from '@/src/content/animals/pony/package'
...
// preview it at /{locale}/animal/pony/. Production builds filter
