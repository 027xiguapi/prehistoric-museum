...
import { en } from '@/src/content/animals/red-panda/content.en'
import { zhCN } from '@/src/content/animals/red-panda/content.zh-CN'
import { provenance } from '@/src/content/animals/red-panda/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '试点草稿：模型已按米制规范化并落地（高约 0.379 米、长约 1.05 米）。',
