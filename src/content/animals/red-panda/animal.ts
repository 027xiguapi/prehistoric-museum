import posterPortraitUrl from '@/src/content/animals/red-panda/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/red-panda/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/red-panda/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a red-panda
...
import { animalDefinition } from '@/src/content/animals/red-panda/package'
...
// server can preview it at /{locale}/animal/red-panda/. Production builds
