import posterPortraitUrl from '@/src/content/animals/emperor-penguin/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/emperor-penguin/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/emperor-penguin/images/thumbnail.webp'

// Draft preview only: borrow the mammoth backdrop until a emperor-penguin
...
import { animalDefinition } from '@/src/content/animals/emperor-penguin/package'
...
// preview it at /{locale}/animal/emperor-penguin/. Production builds filter
