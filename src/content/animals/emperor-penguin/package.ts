...
import { en } from '@/src/content/animals/emperor-penguin/content.en'
import { zhCN } from '@/src/content/animals/emperor-penguin/content.zh-CN'
import { provenance } from '@/src/content/animals/emperor-penguin/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 1.2 米、长约 0.647 米）。',
