...
import { en } from '@/src/content/animals/great-white-shark/content.en'
import { zhCN } from '@/src/content/animals/great-white-shark/content.zh-CN'
import { provenance } from '@/src/content/animals/great-white-shark/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 1.353 米、长约 4.5 米）。',
