import posterPortraitUrl from '@/src/content/animals/frog/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/frog/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/frog/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a frog
...
import { animalDefinition } from '@/src/content/animals/frog/package'
...
// server can preview it at /{locale}/animal/frog/. Production builds
