import posterPortraitUrl from '@/src/content/animals/alligator/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/alligator/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/alligator/images/thumbnail.webp'
...
import landscapeUrl from '@/src/content/animals/alligator/backgrounds/landscape.webp'
import portraitUrl from '@/src/content/animals/alligator/backgrounds/portrait.webp'

import { imageUrl } from '@/src/content/create-runtime-animal'
import { animalAssetUrl } from '@/src/content/remote-assets'
import { animalDefinition } from '@/src/content/animals/alligator/package'
...
// server can preview it at /{locale}/animal/alligator/. Production builds
...
export const animal: DraftAnimalPackage & LegacyLocalReviewAnimalPackage = {
  ...
  review: {
    ...
    checks: [
      '模型已按米制规范化并落地',
      '待机动画 clip “Animation_GLTF_created_0” 待真实浏览器验收',
      '缩略图与海报已从模型渲染',
    ],
    accent: {
      strong: '#3f5245',
