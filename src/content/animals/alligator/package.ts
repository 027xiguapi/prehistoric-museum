...
import { en } from '@/src/content/animals/alligator/content.en'
import { zhCN } from '@/src/content/animals/alligator/content.zh-CN'
import { provenance } from '@/src/content/animals/alligator/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '试点草稿：模型已按米制规范化并落地（高约 0.476 米、长约 3.5 米）。',
    '待机动画 clip 名为 “Animation_GLTF_created_0”，在真实浏览器中验证动作幅度后再决定是否重命名或调速度。',
