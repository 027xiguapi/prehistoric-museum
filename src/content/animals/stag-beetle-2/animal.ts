import posterPortraitUrl from '@/src/content/animals/stag-beetle-2/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/stag-beetle-2/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/stag-beetle-2/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a stag-beetle-2
...
import { animalDefinition } from '@/src/content/animals/stag-beetle-2/package'
...
// preview it at /{locale}/animal/stag-beetle-2/. Production builds filter
