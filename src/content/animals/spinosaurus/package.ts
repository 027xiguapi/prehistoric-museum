...
import { en } from '@/src/content/animals/spinosaurus/content.en'
import { zhCN } from '@/src/content/animals/spinosaurus/content.zh-CN'
import { provenance } from '@/src/content/animals/spinosaurus/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 8.494 米、长约 14 米）。',
