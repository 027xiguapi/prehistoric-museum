...
import { en } from '@/src/content/animals/labrador-retriever-2/content.en'
import { zhCN } from '@/src/content/animals/labrador-retriever-2/content.zh-CN'
import { provenance } from '@/src/content/animals/labrador-retriever-2/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 0.789 米、长约 1.15 米）。',
