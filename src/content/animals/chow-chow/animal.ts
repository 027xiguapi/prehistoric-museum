import posterPortraitUrl from '@/src/content/animals/chow-chow/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/chow-chow/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/chow-chow/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a chow-chow
...
import { animalDefinition } from '@/src/content/animals/chow-chow/package'
...
// preview it at /{locale}/animal/chow-chow/. Production builds filter
