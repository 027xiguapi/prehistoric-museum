import posterPortraitUrl from '@/src/content/animals/sheep/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/sheep/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/sheep/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a sheep
...
import { animalDefinition } from '@/src/content/animals/sheep/package'
...
// server can preview it at /{locale}/animal/sheep/. Production builds
