...
import { en } from '@/src/content/animals/mantis/content.en'
import { zhCN } from '@/src/content/animals/mantis/content.zh-CN'
import { provenance } from '@/src/content/animals/mantis/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 0.033 米、长约 0.1 米，初始朝向 180°）。',
