import posterPortraitUrl from '@/src/content/animals/walkers-cicada/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/walkers-cicada/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/walkers-cicada/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a walkers-cicada
...
import { animalDefinition } from '@/src/content/animals/walkers-cicada/package'
...
// preview it at /{locale}/animal/walkers-cicada/. Production builds filter
