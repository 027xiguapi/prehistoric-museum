import posterPortraitUrl from '@/src/content/animals/firefly/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/firefly/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/firefly/images/thumbnail.webp'

// Draft preview only: borrow the pteranodon backdrop until a firefly
...
import { animalDefinition } from '@/src/content/animals/firefly/package'
...
// preview it at /{locale}/animal/firefly/. Production builds filter
