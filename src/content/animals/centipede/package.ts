...
import { en } from '@/src/content/animals/centipede/content.en'
import { zhCN } from '@/src/content/animals/centipede/content.zh-CN'
import { provenance } from '@/src/content/animals/centipede/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '试点草稿：模型已按米制规范化并落地（高约 0.023 米、长约 0.297 米，初始朝向 135°）。',
    '待机动画 clip 名为 “nyi-Test”，在真实浏览器中验证动作幅度后再决定是否重命名或调速度。',
