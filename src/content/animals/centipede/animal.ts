import posterPortraitUrl from '@/src/content/animals/centipede/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/centipede/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/centipede/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a centipede
...
import { animalDefinition } from '@/src/content/animals/centipede/package'
...
// server can preview it at /{locale}/animal/centipede/. Production builds
