import posterPortraitUrl from '@/src/content/animals/salmon/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/salmon/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/salmon/images/thumbnail.webp'

// Draft preview only: borrow the mosasaurus backdrop until a salmon
...
import { animalDefinition } from '@/src/content/animals/salmon/package'
...
// server can preview it at /{locale}/animal/salmon/. Production builds
...
export const animal: DraftAnimalPackage & LegacyLocalReviewAnimalPackage = {
  ...
  review: {
    ...
    checks: [
      '模型已按米制规范化并落地',
      '待机动画 clip “swim_metest” 待真实浏览器验收',
      '缩略图与海报已从模型渲染',
    ],
    accent: {
      strong: '#7a6a8e',
