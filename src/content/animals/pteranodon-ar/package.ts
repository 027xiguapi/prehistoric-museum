...
import { en } from '@/src/content/animals/pteranodon-ar/content.en'
import { zhCN } from '@/src/content/animals/pteranodon-ar/content.zh-CN'
import { provenance } from '@/src/content/animals/pteranodon-ar/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 5.116 米、长约 6.656 米）。',
