import posterPortraitUrl from '@/src/content/animals/kangaroo/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/kangaroo/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/kangaroo/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a kangaroo
...
import { animalDefinition } from '@/src/content/animals/kangaroo/package'
...
// server can preview it at /{locale}/animal/kangaroo/. Production builds
