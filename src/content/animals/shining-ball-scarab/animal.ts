import posterPortraitUrl from '@/src/content/animals/shining-ball-scarab/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/shining-ball-scarab/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/shining-ball-scarab/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a shining-ball-scarab
...
import { animalDefinition } from '@/src/content/animals/shining-ball-scarab/package'
...
// preview it at /{locale}/animal/shining-ball-scarab/. Production builds filter
...
export const animal: DraftAnimalPackage & LegacyLocalReviewAnimalPackage = {
  ...
  review: {
    ...
    checks: [
      '模型已按米制规范化并落地',
      '待机动画 clip “New animation” 待真实浏览器验收',
      '缩略图与海报已从模型渲染',
    ],
    accent: {
      strong: '#4a6b4f',
