import posterPortraitUrl from '@/src/content/animals/sea-turtle/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/sea-turtle/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/sea-turtle/images/thumbnail.webp'

// Draft preview only: borrow the mosasaurus backdrop until a sea-turtle
...
import { animalDefinition } from '@/src/content/animals/sea-turtle/package'
...
// server can preview it at /{locale}/animal/sea-turtle/. Production builds
...
export const animal: DraftAnimalPackage & LegacyLocalReviewAnimalPackage = {
  ...
  review: {
    ...
    checks: [
      '模型已按米制规范化并落地',
      '待机动画 clip “Animation_Armature” 待真实浏览器验收',
      '缩略图与海报已从模型渲染',
    ],
    accent: {
      strong: '#4d6f66',
