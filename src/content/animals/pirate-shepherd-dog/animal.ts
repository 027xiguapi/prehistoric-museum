import posterPortraitUrl from '@/src/content/animals/pirate-shepherd-dog/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/pirate-shepherd-dog/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/pirate-shepherd-dog/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a pirate-shepherd-dog
...
import { animalDefinition } from '@/src/content/animals/pirate-shepherd-dog/package'
...
// server can preview it at /{locale}/animal/pirate-shepherd-dog/. Production builds
