import posterPortraitUrl from '@/src/content/animals/cheetah/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/cheetah/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/cheetah/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a cheetah
...
import { animalDefinition } from '@/src/content/animals/cheetah/package'
...
// preview it at /{locale}/animal/cheetah/. Production builds filter
