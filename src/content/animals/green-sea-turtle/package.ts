...
import { en } from '@/src/content/animals/green-sea-turtle/content.en'
import { zhCN } from '@/src/content/animals/green-sea-turtle/content.zh-CN'
import { provenance } from '@/src/content/animals/green-sea-turtle/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 0.309 米、长约 1.254 米）。',
