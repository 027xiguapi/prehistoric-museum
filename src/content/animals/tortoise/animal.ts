import posterPortraitUrl from '@/src/content/animals/tortoise/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/tortoise/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/tortoise/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a tortoise
...
import { animalDefinition } from '@/src/content/animals/tortoise/package'
...
// server can preview it at /{locale}/animal/tortoise/. Production builds
