...
import { en } from '@/src/content/animals/guinea-pig/content.en'
import { zhCN } from '@/src/content/animals/guinea-pig/content.zh-CN'
import { provenance } from '@/src/content/animals/guinea-pig/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 0.172 米、长约 0.35 米）。',
