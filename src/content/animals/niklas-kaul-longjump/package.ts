...
import { en } from '@/src/content/animals/niklas-kaul-longjump/content.en'
import { zhCN } from '@/src/content/animals/niklas-kaul-longjump/content.zh-CN'
import { provenance } from '@/src/content/animals/niklas-kaul-longjump/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 2.4 米、长约 1.73 米，初始朝向 270°）。',
