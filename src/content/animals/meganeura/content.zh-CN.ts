...
export const zhCN = {
  ...
  "parentClassificationNote": "巨脉蜻蜓是与现代蜻蜓相关的已灭绝大型飞行昆虫，并不是真正的现代蜻蜓。法国 Commentry 的晚石炭世化石显示翼展约 70 厘米；模式标本保存的翅脉是复原四片翅膀的重要依据。近缘巨脉类腿上的强棘支持它们把六足合成空中捕猎篮，但巨脉蜻蜓的完整身体保存有限。模型的黄黑配色、半透明翼膜、精确翅脉分叉、腿棘数量和拍翼方式都是科学约束下的艺术复原。",
  "sources": [
    {
