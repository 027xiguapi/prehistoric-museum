import posterPortraitUrl from '@/src/content/animals/mallard-duck/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/mallard-duck/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/mallard-duck/images/thumbnail.webp'

// Draft preview only: borrow the mosasaurus backdrop until a mallard-duck
...
import { animalDefinition } from '@/src/content/animals/mallard-duck/package'
...
// preview it at /{locale}/animal/mallard-duck/. Production builds filter
