import posterPortraitUrl from '@/src/content/animals/raccoon/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/raccoon/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/raccoon/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a raccoon
...
import { animalDefinition } from '@/src/content/animals/raccoon/package'
...
// server can preview it at /{locale}/animal/raccoon/. Production builds
...
export const animal: DraftAnimalPackage & LegacyLocalReviewAnimalPackage = {
  ...
  review: {
    ...
    checks: [
      '模型已按米制规范化并落地',
      '待机动画 clip “Animation_Armature.001” 待真实浏览器验收',
      '缩略图与海报已从模型渲染',
    ],
    accent: {
      strong: '#5c5f68',
