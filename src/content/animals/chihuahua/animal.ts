import posterPortraitUrl from '@/src/content/animals/chihuahua/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/chihuahua/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/chihuahua/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a chihuahua
...
import { animalDefinition } from '@/src/content/animals/chihuahua/package'
...
// preview it at /{locale}/animal/chihuahua/. Production builds filter
...
export const animal: DraftAnimalPackage & LegacyLocalReviewAnimalPackage = {
  ...
  review: {
    ...
    checks: [
      '模型已按米制规范化并落地',
      '待机动画 clip “Take 001.001” 待真实浏览器验收',
      '缩略图与海报已从模型渲染',
    ],
    accent: {
      strong: '#b98a5a',
