import posterPortraitUrl from '@/src/content/animals/raccoon-ar/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/raccoon-ar/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/raccoon-ar/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a raccoon-ar
...
import { animalDefinition } from '@/src/content/animals/raccoon-ar/package'
...
// preview it at /{locale}/animal/raccoon-ar/. Production builds filter
