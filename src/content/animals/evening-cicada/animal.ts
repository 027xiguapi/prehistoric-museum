import posterPortraitUrl from '@/src/content/animals/evening-cicada/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/evening-cicada/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/evening-cicada/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a evening-cicada
...
import { animalDefinition } from '@/src/content/animals/evening-cicada/package'
...
// preview it at /{locale}/animal/evening-cicada/. Production builds filter
