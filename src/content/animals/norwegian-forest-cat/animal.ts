import posterPortraitUrl from '@/src/content/animals/norwegian-forest-cat/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/norwegian-forest-cat/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/norwegian-forest-cat/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a norwegian-forest-cat
...
import { animalDefinition } from '@/src/content/animals/norwegian-forest-cat/package'
...
// server can preview it at /{locale}/animal/norwegian-forest-cat/. Production builds
