import posterPortraitUrl from '@/src/content/animals/caeleb-dressel-start/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/caeleb-dressel-start/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/caeleb-dressel-start/images/thumbnail.webp'

// Draft preview only: borrow the mosasaurus backdrop until a caeleb-dressel-start
...
import { animalDefinition } from '@/src/content/animals/caeleb-dressel-start/package'
...
// preview it at /{locale}/animal/caeleb-dressel-start/. Production builds filter
