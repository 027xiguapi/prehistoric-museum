import posterPortraitUrl from '@/src/content/animals/kitten/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/kitten/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/kitten/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a kitten
...
import { animalDefinition } from '@/src/content/animals/kitten/package'
...
// server can preview it at /{locale}/animal/kitten/. Production builds
