...
import { en } from '@/src/content/animals/kitten/content.en'
import { zhCN } from '@/src/content/animals/kitten/content.zh-CN'
import { provenance } from '@/src/content/animals/kitten/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '试点草稿：模型已按米制规范化并落地（高约 0.266 米、长约 0.4 米）。',
