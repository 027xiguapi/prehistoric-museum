import posterPortraitUrl from '@/src/content/animals/snail/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/snail/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/snail/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a snail
...
import { animalDefinition } from '@/src/content/animals/snail/package'
...
// server can preview it at /{locale}/animal/snail/. Production builds
...
export const animal: DraftAnimalPackage & LegacyLocalReviewAnimalPackage = {
  ...
  review: {
    ...
    checks: [
      '模型已按米制规范化并落地',
      '待机动画 clip “snail_idle_anim” 待真实浏览器验收',
      '缩略图与海报已从模型渲染',
    ],
    accent: {
      strong: '#6f7a5c',
