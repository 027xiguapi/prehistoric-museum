...
import { en } from '@/src/content/animals/sphynx-cat-ar/content.en'
import { zhCN } from '@/src/content/animals/sphynx-cat-ar/content.zh-CN'
import { provenance } from '@/src/content/animals/sphynx-cat-ar/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 0.321 米、长约 0.6 米）。',
