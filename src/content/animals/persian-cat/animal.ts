import posterPortraitUrl from '@/src/content/animals/persian-cat/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/persian-cat/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/persian-cat/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a persian-cat
...
import { animalDefinition } from '@/src/content/animals/persian-cat/package'
...
// server can preview it at /{locale}/animal/persian-cat/. Production builds
