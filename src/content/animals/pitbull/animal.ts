import posterPortraitUrl from '@/src/content/animals/pitbull/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/pitbull/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/pitbull/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a pitbull
...
import { animalDefinition } from '@/src/content/animals/pitbull/package'
...
// preview it at /{locale}/animal/pitbull/. Production builds filter
