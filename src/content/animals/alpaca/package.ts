...
import { en } from '@/src/content/animals/alpaca/content.en'
import { zhCN } from '@/src/content/animals/alpaca/content.zh-CN'
import { provenance } from '@/src/content/animals/alpaca/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '试点草稿：模型已按米制规范化并落地（高约 1.6 米、长约 1.354 米）。',
