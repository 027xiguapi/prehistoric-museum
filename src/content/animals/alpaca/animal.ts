import posterPortraitUrl from '@/src/content/animals/alpaca/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/alpaca/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/alpaca/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a alpaca
...
import { animalDefinition } from '@/src/content/animals/alpaca/package'
...
// server can preview it at /{locale}/animal/alpaca/. Production builds
