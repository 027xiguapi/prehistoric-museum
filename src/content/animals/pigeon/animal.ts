import posterPortraitUrl from '@/src/content/animals/pigeon/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/pigeon/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/pigeon/images/thumbnail.webp'

// Draft preview only: borrow the pteranodon backdrop until a pigeon
...
import { animalDefinition } from '@/src/content/animals/pigeon/package'
...
// server can preview it at /{locale}/animal/pigeon/. Production builds
