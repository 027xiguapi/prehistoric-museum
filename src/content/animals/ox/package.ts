...
import { en } from '@/src/content/animals/ox/content.en'
import { zhCN } from '@/src/content/animals/ox/content.zh-CN'
import { provenance } from '@/src/content/animals/ox/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '试点草稿：模型已按米制规范化并落地（高约 1.529 米、长约 2.5 米）。',
