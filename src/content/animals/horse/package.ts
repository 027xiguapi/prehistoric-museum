...
import { en } from '@/src/content/animals/horse/content.en'
import { zhCN } from '@/src/content/animals/horse/content.zh-CN'
import { provenance } from '@/src/content/animals/horse/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '试点草稿：模型已按米制规范化并落地（高约 1.897 米、长约 2.4 米）。',
    '待机动画 clip 名为 “idel_testnyi”，在真实浏览器中验证动作幅度后再决定是否重命名或调速度。',
