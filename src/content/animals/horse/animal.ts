import posterPortraitUrl from '@/src/content/animals/horse/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/horse/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/horse/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a horse
...
import { animalDefinition } from '@/src/content/animals/horse/package'
...
// server can preview it at /{locale}/animal/horse/. Production builds
...
export const animal: DraftAnimalPackage & LegacyLocalReviewAnimalPackage = {
  ...
  review: {
    ...
    checks: [
      '模型已按米制规范化并落地',
      '待机动画 clip “idel_testnyi” 待真实浏览器验收',
      '缩略图与海报已从模型渲染',
    ],
    accent: {
      strong: '#7a5b3e',
