import posterPortraitUrl from '@/src/content/animals/zebra-ar/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/zebra-ar/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/zebra-ar/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a zebra-ar
...
import { animalDefinition } from '@/src/content/animals/zebra-ar/package'
...
// preview it at /{locale}/animal/zebra-ar/. Production builds filter
