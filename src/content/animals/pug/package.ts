...
import { en } from '@/src/content/animals/pug/content.en'
import { zhCN } from '@/src/content/animals/pug/content.zh-CN'
import { provenance } from '@/src/content/animals/pug/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '试点草稿：模型已按米制规范化并落地（高约 0.466 米、长约 0.55 米）。',
