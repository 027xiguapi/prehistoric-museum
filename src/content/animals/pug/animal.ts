import posterPortraitUrl from '@/src/content/animals/pug/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/pug/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/pug/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a pug
...
import { animalDefinition } from '@/src/content/animals/pug/package'
...
// server can preview it at /{locale}/animal/pug/. Production builds
