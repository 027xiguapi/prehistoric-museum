...
import { en } from '@/src/content/animals/bull/content.en'
import { zhCN } from '@/src/content/animals/bull/content.zh-CN'
import { provenance } from '@/src/content/animals/bull/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '试点草稿：模型已按米制规范化并落地（高约 1.775 米、长约 3.4 米）。',
    '待机动画 clip 名为 “Action”，在真实浏览器中验证动作幅度后再决定是否重命名或调速度。',
