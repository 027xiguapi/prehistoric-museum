import posterPortraitUrl from '@/src/content/animals/bull/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/bull/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/bull/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a bull
...
import { animalDefinition } from '@/src/content/animals/bull/package'
...
// server can preview it at /{locale}/animal/bull/. Production builds
