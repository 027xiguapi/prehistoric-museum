...
import { en } from '@/src/content/animals/giraffe/content.en'
import { zhCN } from '@/src/content/animals/giraffe/content.zh-CN'
import { provenance } from '@/src/content/animals/giraffe/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 4.8 米、长约 3.264 米）。',
