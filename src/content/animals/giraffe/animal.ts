import posterPortraitUrl from '@/src/content/animals/giraffe/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/giraffe/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/giraffe/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a giraffe
...
import { animalDefinition } from '@/src/content/animals/giraffe/package'
...
// preview it at /{locale}/animal/giraffe/. Production builds filter
