import posterPortraitUrl from '@/src/content/animals/hercules-beetle/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/hercules-beetle/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/hercules-beetle/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a hercules-beetle
...
import { animalDefinition } from '@/src/content/animals/hercules-beetle/package'
...
// server can preview it at /{locale}/animal/hercules-beetle/. Production builds
...
export const animal: DraftAnimalPackage & LegacyLocalReviewAnimalPackage = {
  ...
  review: {
    ...
    checks: [
      '模型已按米制规范化并落地',
      '待机动画 clip “hurkyury_Armature” 待真实浏览器验收',
      '缩略图与海报已从模型渲染',
    ],
    accent: {
      strong: '#4f4232',
