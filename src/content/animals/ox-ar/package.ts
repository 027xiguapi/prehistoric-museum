...
import { en } from '@/src/content/animals/ox-ar/content.en'
import { zhCN } from '@/src/content/animals/ox-ar/content.zh-CN'
import { provenance } from '@/src/content/animals/ox-ar/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 1.533 米、长约 2.5 米）。',
