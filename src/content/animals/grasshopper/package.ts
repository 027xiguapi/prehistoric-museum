...
import { en } from '@/src/content/animals/grasshopper/content.en'
import { zhCN } from '@/src/content/animals/grasshopper/content.zh-CN'
import { provenance } from '@/src/content/animals/grasshopper/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 0.036 米、长约 0.09 米，初始朝向 180°）。',
    '待机动画 clip 名为 “tonosama”，在真实浏览器中验证动作幅度后再决定是否重命名或调速度。',
