import posterPortraitUrl from '@/src/content/animals/woodpecker/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/woodpecker/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/woodpecker/images/thumbnail.webp'

// Draft preview only: borrow the pteranodon backdrop until a woodpecker
...
import { animalDefinition } from '@/src/content/animals/woodpecker/package'
...
// preview it at /{locale}/animal/woodpecker/. Production builds filter
