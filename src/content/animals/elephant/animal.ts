import posterPortraitUrl from '@/src/content/animals/elephant/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/elephant/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/elephant/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a elephant
...
import { animalDefinition } from '@/src/content/animals/elephant/package'
...
// server can preview it at /{locale}/animal/elephant/. Production builds
...
export const animal: DraftAnimalPackage & LegacyLocalReviewAnimalPackage = {
  ...
  review: {
    ...
    checks: [
      '模型已按米制规范化并落地',
      '待机动画 clip “TRS|Take 001|BaseLayer” 待真实浏览器验收',
      '缩略图与海报已从模型渲染',
    ],
    accent: {
      strong: '#6f6a63',
