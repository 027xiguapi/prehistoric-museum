...
import { en } from '@/src/content/animals/elephant/content.en'
import { zhCN } from '@/src/content/animals/elephant/content.zh-CN'
import { provenance } from '@/src/content/animals/elephant/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '试点草稿：模型已按米制规范化并落地（高约 4.494 米、长约 6.5 米）。',
    '待机动画 clip 名为 “TRS|Take 001|BaseLayer”，在真实浏览器中验证动作幅度后再决定是否重命名或调速度。',
