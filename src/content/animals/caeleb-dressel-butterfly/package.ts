...
import { en } from '@/src/content/animals/caeleb-dressel-butterfly/content.en'
import { zhCN } from '@/src/content/animals/caeleb-dressel-butterfly/content.zh-CN'
import { provenance } from '@/src/content/animals/caeleb-dressel-butterfly/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 2.3 米、长约 1.208 米）。',
