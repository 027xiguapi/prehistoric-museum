import posterPortraitUrl from '@/src/content/animals/caeleb-dressel-butterfly/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/caeleb-dressel-butterfly/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/caeleb-dressel-butterfly/images/thumbnail.webp'

// Draft preview only: borrow the mosasaurus backdrop until a caeleb-dressel-butterfly
...
import { animalDefinition } from '@/src/content/animals/caeleb-dressel-butterfly/package'
...
// preview it at /{locale}/animal/caeleb-dressel-butterfly/. Production builds filter
