import posterPortraitUrl from '@/src/content/animals/mouse/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/mouse/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/mouse/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a mouse
...
import { animalDefinition } from '@/src/content/animals/mouse/package'
...
// server can preview it at /{locale}/animal/mouse/. Production builds
