import posterPortraitUrl from '@/src/content/animals/welsh-corgi/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/welsh-corgi/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/welsh-corgi/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a welsh-corgi
...
import { animalDefinition } from '@/src/content/animals/welsh-corgi/package'
...
// preview it at /{locale}/animal/welsh-corgi/. Production builds filter
