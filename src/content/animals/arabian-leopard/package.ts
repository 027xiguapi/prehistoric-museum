...
import { en } from '@/src/content/animals/arabian-leopard/content.en'
import { zhCN } from '@/src/content/animals/arabian-leopard/content.zh-CN'
import { provenance } from '@/src/content/animals/arabian-leopard/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '试点草稿：模型已按米制规范化并落地（高约 0.954 米、长约 1.8 米）。',
