import posterPortraitUrl from '@/src/content/animals/schnauzer-ar/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/schnauzer-ar/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/schnauzer-ar/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a schnauzer-ar
...
import { animalDefinition } from '@/src/content/animals/schnauzer-ar/package'
...
// preview it at /{locale}/animal/schnauzer-ar/. Production builds filter
