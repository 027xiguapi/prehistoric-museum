import posterPortraitUrl from '@/src/content/animals/scorpion/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/scorpion/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/scorpion/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a scorpion
...
import { animalDefinition } from '@/src/content/animals/scorpion/package'
...
// server can preview it at /{locale}/animal/scorpion/. Production builds
...
export const animal: DraftAnimalPackage & LegacyLocalReviewAnimalPackage = {
  ...
  review: {
    ...
    checks: [
      '模型已按米制规范化并落地',
      '待机动画 clip “Attackidle_nyi” 待真实浏览器验收',
      '缩略图与海报已从模型渲染',
    ],
    accent: {
      strong: '#6b4a2e',
