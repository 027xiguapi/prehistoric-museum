import posterPortraitUrl from '@/src/content/animals/crab/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/crab/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/crab/images/thumbnail.webp'

// Draft preview only: borrow the mosasaurus backdrop until a crab
...
import { animalDefinition } from '@/src/content/animals/crab/package'
...
// server can preview it at /{locale}/animal/crab/. Production builds
...
export const animal: DraftAnimalPackage & LegacyLocalReviewAnimalPackage = {
  ...
  review: {
    ...
    checks: [
      '模型已按米制规范化并落地',
      '待机动画 clip “crab_run_anim” 待真实浏览器验收',
      '缩略图与海报已从模型渲染',
    ],
    accent: {
      strong: '#b0432f',
