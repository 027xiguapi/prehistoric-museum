import posterPortraitUrl from '@/src/content/animals/scottish-fold/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/scottish-fold/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/scottish-fold/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a scottish-fold
...
import { animalDefinition } from '@/src/content/animals/scottish-fold/package'
...
// preview it at /{locale}/animal/scottish-fold/. Production builds filter
