import posterPortraitUrl from '@/src/content/animals/dachshund/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/dachshund/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/dachshund/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a dachshund
...
import { animalDefinition } from '@/src/content/animals/dachshund/package'
...
// preview it at /{locale}/animal/dachshund/. Production builds filter
