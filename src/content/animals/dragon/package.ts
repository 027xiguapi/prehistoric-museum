...
import { en } from '@/src/content/animals/dragon/content.en'
import { zhCN } from '@/src/content/animals/dragon/content.zh-CN'
import { provenance } from '@/src/content/animals/dragon/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 2.075 米、长约 4.5 米，初始朝向 180°）。',
