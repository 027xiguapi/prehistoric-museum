import posterPortraitUrl from '@/src/content/animals/rabbit/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/rabbit/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/rabbit/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a rabbit
...
import { animalDefinition } from '@/src/content/animals/rabbit/package'
...
// server can preview it at /{locale}/animal/rabbit/. Production builds
...
export const animal: DraftAnimalPackage & LegacyLocalReviewAnimalPackage = {
  ...
  review: {
    ...
    checks: [
      '模型已按米制规范化并落地',
      '待机动画 clip “All Animations_Armature” 待真实浏览器验收',
      '缩略图与海报已从模型渲染',
    ],
    accent: {
      strong: '#8a7d70',
