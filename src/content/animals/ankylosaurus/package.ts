...
import { en } from '@/src/content/animals/ankylosaurus/content.en'
import { zhCN } from '@/src/content/animals/ankylosaurus/content.zh-CN'
import { provenance } from '@/src/content/animals/ankylosaurus/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 3.059 米、长约 9.111 米，初始朝向 45°）。',
