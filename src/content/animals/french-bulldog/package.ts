...
import { en } from '@/src/content/animals/french-bulldog/content.en'
import { zhCN } from '@/src/content/animals/french-bulldog/content.zh-CN'
import { provenance } from '@/src/content/animals/french-bulldog/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 0.489 米、长约 0.55 米）。',
