import posterPortraitUrl from '@/src/content/animals/parasaurolophus/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/parasaurolophus/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/parasaurolophus/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a parasaurolophus
...
import { animalDefinition } from '@/src/content/animals/parasaurolophus/package'
...
// preview it at /{locale}/animal/parasaurolophus/. Production builds filter
