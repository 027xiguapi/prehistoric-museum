...
import { en } from '@/src/content/animals/parasaurolophus/content.en'
import { zhCN } from '@/src/content/animals/parasaurolophus/content.zh-CN'
import { provenance } from '@/src/content/animals/parasaurolophus/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 6.357 米、长约 11.843 米，初始朝向 45°）。',
