import posterPortraitUrl from '@/src/content/animals/rabbit-ar/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/rabbit-ar/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/rabbit-ar/images/thumbnail.webp'

// Draft preview only: borrow the apatosaurus backdrop until a rabbit-ar
...
import { animalDefinition } from '@/src/content/animals/rabbit-ar/package'
...
// preview it at /{locale}/animal/rabbit-ar/. Production builds filter
