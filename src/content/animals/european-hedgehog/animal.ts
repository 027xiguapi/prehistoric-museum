import posterPortraitUrl from '@/src/content/animals/european-hedgehog/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/european-hedgehog/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/european-hedgehog/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a european-hedgehog
...
import { animalDefinition } from '@/src/content/animals/european-hedgehog/package'
...
// preview it at /{locale}/animal/european-hedgehog/. Production builds filter
