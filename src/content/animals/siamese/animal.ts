import posterPortraitUrl from '@/src/content/animals/siamese/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/siamese/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/siamese/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a siamese
...
import { animalDefinition } from '@/src/content/animals/siamese/package'
...
// preview it at /{locale}/animal/siamese/. Production builds filter
