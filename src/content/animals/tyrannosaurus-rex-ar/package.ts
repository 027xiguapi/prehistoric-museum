...
import { en } from '@/src/content/animals/tyrannosaurus-rex-ar/content.en'
import { zhCN } from '@/src/content/animals/tyrannosaurus-rex-ar/content.zh-CN'
import { provenance } from '@/src/content/animals/tyrannosaurus-rex-ar/provenance'
...
export const animalDefinition: DraftAnimalDefinition = {
  ...
  provenance,
  draftNotes: [
    '下载批次草稿：模型已按米制规范化并落地（高约 7.383 米、长约 12.3 米，初始朝向 270°）。',
