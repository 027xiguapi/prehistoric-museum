import posterPortraitUrl from '@/src/content/animals/saola/images/poster-portrait.webp'
import posterUrl from '@/src/content/animals/saola/images/poster.webp'
import thumbnailUrl from '@/src/content/animals/saola/images/thumbnail.webp'

// Draft preview only: borrow the stegosaurus backdrop until a saola
...
import { animalDefinition } from '@/src/content/animals/saola/package'
...
// preview it at /{locale}/animal/saola/. Production builds filter
