...
export const provenance: readonly [AssetProvenance, ...AssetProvenance[]] = [
  {
    ...
    source: {
      type: 'third-party',
      title: "Saola (Google “AR Answers in Search” models bucket)",
      author: 'Google',
      url: "https://storage.googleapis.com/ar-answers-in-search-models/static/african_endangered/Saola/saola.glb",
    ...
    modifications: [
      ...
      'Wrapped the scene in a normalization node so the model is unit-scale in metres, centred on the origin, and grounded at y = 0 (scale ×1.22; height ≈ 1.5 m, length ≈ 1.42 m).',
